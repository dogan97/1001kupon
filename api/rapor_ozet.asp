...
If rs.EOF Then 
  JsonWrite "{""ok"":true,""data"":{""kontor"":0,""toplam"":0,""bekleyen"":0,""kullanilan"":0,""suresi_dolan"":0}}"
Else 
  JsonWrite "{""ok"":true,""data"":{""kontor"":"&rs("kontor")&",""toplam"":"&rs("toplam")&",""bekleyen"":"&rs("bekleyen")&",""kullanilan"":"&rs("kullanilan")&",""suresi_dolan"":"&rs("suresi_dolan")&"}}"
End If
%>
