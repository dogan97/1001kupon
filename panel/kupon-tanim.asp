...
<div class="card-body"><table id="tbl" class="table table-bordered table-striped"><thead><tr><th>Kod</th><th>Ad</th><th>Aciklama</th><th>Tip</th><th>Deger</th><th>Durum</th></tr></thead><tbody></tbody></table></div></div>
...
<div class="form-group"><label>Aciklama</label><textarea class="form-control" name="aciklama" rows="2"></textarea></div>
...
<script>
$(function(){
  const t=$('#tbl').DataTable({columns:[{data:'tanim_kodu'},{data:'tanim_adi'},{data:'aciklama'},{data:'indirim_tipi'},{data:'indirim_degeri'},{data:'durum'}]});
